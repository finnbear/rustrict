...
it has **91.97% accuracy** (89% positive accuracy, 93% negative accuracy), as of version `0.1.13`. Much of the inaccuracy is due to
differences of opinion of what is inappropriate.
